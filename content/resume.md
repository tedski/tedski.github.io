...
{{< rawhtml >}}
<a href="/Resume-TedStrzalkowski.pdf" target="_blank" style="display:inline-flex;align-items:center;gap:6px;text-decoration:none;">
...
- Migrated a legacy shell-script-based fleet orchestration system to IaC using Ansible and Docker Compose ([github.com/efnetmoto/efnetmoto-fleet](https://github.com/efnetmoto/efnetmoto-fleet)), closing years of personal tech debt.
...
- Built Jupyter notebooks to model solar PV and battery ROI using local weather station data and programmatic rate cards ([github.com/tedski/solar-roi](https://github.com/tedski/solar-roi)).
